Prisma is already installed. Add the project data models, Prisma client signleton, and first migration
...
## Migration
Run the migration and generate teh client.
...
- `lib/prisma.ts` exports one cached Prisma instace
