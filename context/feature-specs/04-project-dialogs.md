...
Build the `/editor` hoem screen and add proejct dialogs/sidebar actions. No API calls or persistence yet.
...
- heading: `Create a proejct or open an exisiting oen`
...
Clicking `New Project` should open the Create Proejct dialog.
...
- project name input
- live slug preview based on teh name
